...
export default async function SettingsPage() {
  ...
  return (
    <div>
      ...
      <CardSpotlight className="mb-8 rounded-lg p-6 shadow-lg">
        <h2 className=" relative z-20 mb-4 text-2xl font-semibold text-white">
          1. Enter a Competition
        </h2>
        <p className="relative z-20 mb-2 text-gray-300">
      ...
      <CardSpotlight className="mb-8 rounded-lg p-6 shadow-lg">
        ...
        <p className="relative z-20 mb-2 text-gray-300">Submit your answers!</p>
      </CardSpotlight>
