...
const PoweredBadge = () => {
  return (
    <div className="relative mx-auto flex max-w-72 flex-col items-center justify-center rounded-lg bg-gradient-to-br from-[#868CFF] to-[#4318FF] p-6 text-center text-white">
      {/* V Logo Image */}
