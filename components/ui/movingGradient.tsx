...
export default function MovingGradient({
  ...
  return (
    <div {...props} className={cn("relative overflow-hidden", className)}>
      <div
        className={cn(
          "bg-size bg-gradient-to-r from-primary-500 from-30% via-primary-700 via-50% to-secondary-500 to-80% opacity-25",
          {
            [backgroundClassName]: true,
            "moving-gradient bg-[length:300%_auto]": animated,
          },
          gradientClassName,
        )}
      />
