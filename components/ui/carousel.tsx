  ...
  return (
    ...
    >
      <div className="relative w-full">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth pb-4 [scrollbar-width:none]"
          ref={carouselRef}
        ...
        <div className="mr-10 flex justify-end gap-2">
          <Button
            className="relative z-40 flex items-center justify-center rounded-full bg-content3 disabled:opacity-50"
            onClick={scrollLeft}
  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl  md:h-[40rem] md:w-96"
      >
        <div className="pointer-events-none absolute inset-x-0 top-0 z-30 h-full bg-gradient-to-b from-background/50 via-transparent to-transparent" />
