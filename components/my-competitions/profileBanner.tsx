...
export default function ProfileBanner({
  ...
  return (
    <div
      className="relative flex h-28 w-full items-center overflow-hidden rounded-md border-b-2 bg-content4 p-4 md:h-40 md:p-8"
    ...
    >
      ...
      <div className="z-20 ml-2 flex flex-col md:ml-4">
        ...
        <p className="rounded-md text-xs md:bg-background md:p-1 md:text-sm">
